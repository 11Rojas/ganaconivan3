      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center space-x-3 mb-4">
            ...
            <span className="text-2xl font-bold gradient-text">GANACOMIVAN</span>
          </div>
          <p className="text-gray-400 text-sm">GANACOMIVAN - Acceso Administrativo</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="admin@ganaconivan.com"
                  required
                />
              </div>
